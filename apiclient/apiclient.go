...
type Client interface {
	...
	GetRiotAccountByNameAndTag(ctx context.Context, r region.Region, name string, tag string) (*RiotAccount, error)

	GetRiotAccountByPuuid(ctx context.Context, r region.Region, puuid string) (*RiotAccount, error)
